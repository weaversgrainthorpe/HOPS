...
```
time=2026-05-29T10:00:00.000Z level=INFO msg="server starting" version="HOPS v2.1.1" addr=:8080 data_dir=./data frontend_dir=./frontend/build
```
...
> **Pin a version instead of `:latest`?** Use `ghcr.io/weaversgrainthorpe/hops:v2.1.1` (or any tagged release).
