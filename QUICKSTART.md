...
> **Pin a version instead of `:latest`?** Use `ghcr.io/weaversgrainthorpe/hops:v1.5.4` (or any tagged release).
...
```
time=2026-05-19T10:00:00.000Z level=INFO msg="server starting" version="HOPS v1.5.4" addr=:8080 data_dir=./data frontend_dir=./frontend/build
```
