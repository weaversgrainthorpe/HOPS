...
> **Pin a version instead of `:latest`?** Use `ghcr.io/weaversgrainthorpe/hops:v1.4.12` (or any tagged release).
...
```
time=2026-05-18T10:00:00.000Z level=INFO msg="server starting" version="HOPS v1.4.12" addr=:8080 data_dir=./data frontend_dir=./frontend/build
```
